                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="../admin/theme/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="../admin/theme/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <form action="login.php" method="POST">
                                    <button name="submit" class="btn btn-default btn-flat">Sign out</button>
